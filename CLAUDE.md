...
There is no asset payload: the copy-into-run asset mechanism was deleted in the git-native Phase 2. Assets will return as `(commit, path)` git references (Phase 3).
