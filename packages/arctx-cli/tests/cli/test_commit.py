"""Integration tests for arctx commit CLI with a real git repo."""
...
class TestCommitCLIIntegration:
    def test_arctx_commit_records_transition(self, tmp_path, monkeypatch):
        ...
        _init_arctx(repo, tmp_path, run_id="run_ci")
    ...
    def test_commit_advances_branch_tip(self, tmp_path, monkeypatch):
        ...
        _init_arctx(repo, tmp_path, run_id="run_bt")
    ...
    def test_two_commits_form_chain(self, tmp_path, monkeypatch):
        ...
        _init_arctx(repo, tmp_path, run_id="run_chain")
