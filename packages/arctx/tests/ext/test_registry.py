...
from arctx.core.run import init
from arctx.core.schema.requirements import Requirement
from arctx.ext import Extension, ExtensionBase, list_available, load_extension
...
def test_third_party_discovery():
    ...
    with patch("arctx.ext._get_entry_points", return_value={"myext": mock_ep}):
        avail = list_available()
