...
from stag_api.ext.base import CliCommand, Extension, ExtensionBase, InitContext, Violation

# Built-in extensions. (name -> "module:Class")
_BUILTIN: dict[str, str] = {
    "command": "stag_api.ext.command:CommandExtension",
    "git": "stag_api.ext.git:GitExtension",
}
