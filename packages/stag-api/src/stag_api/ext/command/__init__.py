...
from stag_api.ext.base import CliCommand, ExtensionBase
...
class CommandNamespace:
    ...
    def run(self, **kwargs: Any) -> dict[str, object]:
        from stag_api.ext.command.verbs.run import run_impl
...
class CommandExtension(ExtensionBase):
    ...
    def register_schema(self) -> None:
        import stag_api.ext.command.payloads  # noqa: F401
    ...
    def cli_commands(self) -> list[CliCommand]:
        from stag_cli.ext.command import add_parser, cli_command
