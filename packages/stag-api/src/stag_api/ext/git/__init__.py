...
from stag_api.ext.base import CliCommand, ExtensionBase, InitContext, Violation

if TYPE_CHECKING:
    import argparse

    from stag_api.core.run.handle import RunHandle
...
class GitExtension(ExtensionBase):
    ...
    def register_schema(self) -> None:
        ...
        import stag_api.ext.git.events  # noqa: F401
        import stag_api.ext.git.payloads  # noqa: F401
    ...
    def cli_commands(self) -> list[CliCommand]:
        from stag_cli.commands.git import add_parser, cli_git
    ...
    def on_init(self, ctx: InitContext) -> None:
        from stag_api.paths import find_repo_root, write_stag_id
        from stag_cli.ext.git.hook import run_hook_install
