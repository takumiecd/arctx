...
from stag_api.core.schema.payloads import JoinPayload
from stag_api.ext.git.payloads import MergePayload
...
from stag_api.ext.git.events import latest_branch_tip
