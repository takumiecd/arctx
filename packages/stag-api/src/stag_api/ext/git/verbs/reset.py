...
from stag_api.core.cuts import cut_transition_ids
from stag_api.core.schema.work_helpers import (
    latest_session_pointer,
    make_session_pointer_event,
)
from stag_api.ext.git.events import make_reset_event
    ...
    if mode == "hard":
        ...
        for t_id in discarded_transition_ids:
            if t_id in already_cut:
                continue
            from stag_api.core.schema.payloads import CutPayload  # noqa: PLC0415
            cut = CutPayload(
