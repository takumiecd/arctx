...
from stag_api.core.schema.graph import Transition
from stag_api.ext.git.helpers.repo import resolve_worktree_path
from stag_api.ext.git.payloads import RevertPayload
from stag_api.ext.git.queries import current_sha, transition_by_sha
from stag_api.ext.git.verbs._forward_transition import (
    capture_git_info,
    ...
    *,
    ...
    if head_commit is None:
        if dry_run:
            ...
            from stag_api.ext.git.helpers import repo as git_repo  # noqa: PLC0415
    ...
    from stag_api.core.schema.graph import Node  # noqa: PLC0415
    from stag_api.core.schema.work_helpers import make_session_pointer_event  # noqa: PLC0415
    from stag_api.ext.git.events import (  # noqa: PLC0415
        make_branch_tip_event,
    )
    from stag_api.ext.git.payloads import BranchPayload, GitChangePayload  # noqa: PLC0415
    ...
    from stag_api.core.schema.graph import Transition as _Transition  # noqa: PLC0415
