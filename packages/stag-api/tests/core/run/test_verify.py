...
from stag_api.ext.git.verbs.verify import VerifyViolation
from stag_api.core.schema.requirements import Requirement
import stag_api as stag
from stag_api.ext import attach_extensions
...
class TestVerifyMissingSha:
    def test_transition_without_git_change_payload(self):
        ...
        from stag_api.core.ids import opaque_id
...
class TestVerifyMissingInputSha:
    def test_input_transition_has_no_sha(self):
        ...
        handle = _make_handle()
        from stag_api.core.schema.payloads import TransitionPayload
        from stag_api.ext.git.payloads import GitChangePayload
        from stag_api.core.ids import opaque_id
        ...
        from stag_api.core.schema.graph import Transition as Trans
        t_no_sha = Trans(
