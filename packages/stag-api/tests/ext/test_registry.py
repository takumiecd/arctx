...
from stag_api.core.run import init
from stag_api.core.schema.requirements import Requirement
from stag_api.ext import Extension, ExtensionBase, list_available, load_extension
...
def test_third_party_discovery():
    ...
    with patch("stag_api.ext._get_entry_points", return_value={"myext": mock_ep}):
        avail = list_available()
