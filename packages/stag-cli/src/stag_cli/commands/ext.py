"""stag ext subcommand — manage extensions for a run.
...
def run_ext_list_command(
    *,
    ...
    """
    from stag_api.ext import list_available
...
def run_ext_enable_command(
    *,
    ...
    """
    from stag_api.ext import load_extension
    from stag_api.ext.base import InitContext
    from stag_api.ext.enabled import EnabledExtension, add_enabled, load_enabled
...
def run_ext_disable_command(
    *,
    ...
    """
    from stag_api.ext.enabled import load_enabled, save_enabled
...
def _resolve_run_dir(args) -> str | None:
    ...
    if run_id_arg:
        from stag_cli.paths import resolve_store_dir
