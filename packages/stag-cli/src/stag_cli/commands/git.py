...
from stag_cli.append_batch import graph_counts, maybe_append_or_save
from stag_cli.context import (
...
def add_parser(subparsers) -> argparse.ArgumentParser:
    ...
    from stag_cli.ext.git.branch import add_parser as add_branch_parser
    from stag_cli.ext.git.cherry_pick import add_parser as add_cherry_pick_parser
    from stag_cli.ext.git.commit import add_parser as add_commit_parser
    from stag_cli.ext.git.hook import add_parser as add_hook_parser
    from stag_cli.ext.git.merge import add_parser as add_merge_parser
    from stag_cli.ext.git.reset import add_parser as add_reset_parser
    from stag_cli.ext.git.revert import add_parser as add_revert_parser
    from stag_cli.ext.git.verify import add_parser as add_verify_parser
    from stag_cli.ext.git.worktree import add_parser as add_worktree_parser
...
def cli_git(args) -> int:
    ...
    from stag_cli.ext.git.branch import cli_branch
    from stag_cli.ext.git.cherry_pick import cli_cherry_pick
    from stag_cli.ext.git.commit import cli_commit
    from stag_cli.ext.git.hook import cli_hook
    from stag_cli.ext.git.merge import cli_merge
    from stag_cli.ext.git.reset import cli_reset
    from stag_cli.ext.git.revert import cli_revert
    from stag_cli.ext.git.verify import cli_verify
    ...
    if args.git_command == "worktree":
        from stag_cli.ext.git.worktree import cli_worktree  # noqa: PLC0415
...
def _cli_git_attach(args) -> int:
    ...
    from stag_api.ext.git.helpers.attach import attach_commits_to_transition
