...
from stag_cli.paths import find_repo_root, resolve_store_dir, stag_id_path, write_stag_id
...
def add_parser(subparsers) -> argparse.ArgumentParser:
    ...
    from stag_api.ext import list_available, load_extension  # noqa: PLC0415
...
def run_init_command(
    *,
    ...
    if extensions:
        ...
        from stag_api.ext.base import InitContext  # noqa: PLC0415
        from stag_api.ext.enabled import EnabledExtension, add_enabled  # noqa: PLC0415
