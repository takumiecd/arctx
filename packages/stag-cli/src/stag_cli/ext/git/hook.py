...
def run_hook_install(
    *,
    ...
    """
    from stag_cli.paths import find_repo_root  # noqa: PLC0415
...
def run_hook_post_rewrite(
    *,
    ...
    from stag_cli.context import resolve_store  # noqa: PLC0415
...
def cli_hook(args) -> int:
    ...
    if args.hook_command == "post-rewrite":
        ...
        from stag_cli.context import resolve_run_id_from_args  # noqa: PLC0415
