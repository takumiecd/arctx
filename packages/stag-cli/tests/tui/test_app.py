...
from stag_api import init
from stag_api.core.schema.payloads import NodePayload, TransitionPayload
...
def test_outline_in_tui_scenario():
    from stag_api.core.run.dump import DumpOptions, render_outline
    handle = _make_handle()
...
def test_mermaid_in_tui_scenario():
    from stag_api.core.run.dump import DumpOptions, render_mermaid
    handle = _make_handle()
