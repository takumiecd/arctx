...
from optagent.legacy.core.ids import sequential_id
...
from optagent.legacy.v1.core.state_model import (
    AlgorithmState,
    Artifact,
    EvidenceRecord,
    Hypothesis,
...
from optagent.legacy.v1.core.models import Requirement as RequirementV1
...
class ManagerAgent:
    ...
    def optimize(
        ...
        if return_v1_state:
            ...
            from optagent.legacy.v1.core.models import OptimizationState as OptimizationStateV1
            from optagent.legacy.v1.core.models import Hypothesis as HypothesisV1
            from optagent.legacy.v1.core.models import Artifact as ArtifactV1
            from optagent.legacy.v1.core.models import Evidence as EvidenceV1
            from optagent.legacy.v1.core.models import Decision as DecisionV1
