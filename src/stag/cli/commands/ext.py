...
def run_ext_list_command(
    *,
    ...
    """
    from stag.ext import list_available
...
def run_ext_enable_command(
    *,
    ...
    """
    from stag.ext import load_extension
    from stag.ext.base import InitContext
    from stag.ext.enabled import EnabledExtension, add_enabled, load_enabled
...
def run_ext_disable_command(
    *,
    ...
    """
    from stag.ext.enabled import load_enabled, save_enabled
