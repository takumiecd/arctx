...
from stag.ext.base import CliCommand, ExtensionBase
...
class CommandNamespace:
    ...
    def run(self, **kwargs: Any) -> dict[str, object]:
        from stag.ext.command.verbs.run import run_impl
...
class CommandExtension(ExtensionBase):
    ...
    def register_schema(self) -> None:
        import stag.ext.command.payloads  # noqa: F401
    ...
    def cli_commands(self) -> list[CliCommand]:
        from stag.ext.command.cli import add_parser, cli_command
